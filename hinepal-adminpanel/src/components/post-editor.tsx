...
export function PostEditorComponent({
  ...
  const [formData, setFormData] = useState<TPackage>({
    ...
    thumbnailImageAlt: initialData?.thumbnailImageAlt || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    payload.append("thumbnailImageAlt", formData.thumbnailImageAlt || "");

    formData.banner.length > 0 &&
      formData.banner[0] instanceof File &&
      payload.append("banner", formData.banner[0] || "");
    payload.append("bannerImageAlt", formData.bannerImageAlt || "");
            ...
            <div className="p-4">
              ...
              <section>
                <div className="grid grid-cols-6  my-4 bg-gray-100  p-2  gap-2">
                  <Button
                    type="button"
                    onClick={() => setWhichWriting("overview")}
                  >
                    {" "}
                    Overview
                  </Button>
                  <Button
                    type="button"
                    onClick={() => setWhichWriting("highlights")}
                  >
                    {" "}
                    Highlights
                  </Button>
                ...
                {whichWriting === "overview" && (
                  <div className="space-y-2">
                    <Label className="font-bold text-xl" htmlFor="overview">
                      Overview
                    </Label>
                ...
                {whichWriting === "highlights" && (
                  <div className="space-y-2">
                    <Label className="font-bold text-xl" htmlFor="highlights">
                      Highlights
                    </Label>
                    <div className="border rounded-md">
                      {
                ...
                {whichWriting === "altitudeInfo" && (
                  <div className="space-y-2">
                    <Label className="font-bold text-xl" htmlFor="altitudeInfo">
                      Altitude Info
                    </Label>
                    <div className="border rounded-md">
                      {
                ...
                {whichWriting === "itenary" && (
                  <div className="space-y-2">
                    <Label className="font-bold text-xl" htmlFor="itenary">
                      Itenary
                    </Label>
                    <div className="border rounded-md">
                      {
                ...
                {whichWriting === "packing" && (
                  <div className="space-y-2">
                    <Label className="font-bold text-xl" htmlFor="packing">
                      Packing Essentials
                    </Label>
                    <div className="border rounded-md">
                      {
                ...
                {whichWriting === "includes" && (
                  <div className="space-y-2">
                    <Label className="font-bold text-xl" htmlFor="includes">
                      Includes
                    </Label>
                    <div className="border rounded-md">
                      {
                ...
                {whichWriting === "excludes" && (
                  <div className="space-y-2">
                    <Label className="font-bold text-xl" htmlFor="excludes">
                      Excludes
                    </Label>
                    <div className="border rounded-md">
                      {
                ...
                {whichWriting === "bookingInfo" && (
                  <div className="space-y-2">
                    <Label className="font-bold text-xl" htmlFor="bookingInfo">
                      Booking Info and Final Thoughts
                    </Label>
                    <div className="border rounded-md">
                      {
                        <CustomCKEditor
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    placeholder="Enter viable transportation options. E.g. Car, Bus, etc."
                  />
                </div>
                <div className="space-y-2">
              ...
              {/* banner image alt */}
              <div className="space-y-2">
                <Label htmlFor="permits"> Banner Image Alt Text</Label>
                <Input
                  id="bannerImageAlt"
                  name="bannerImageAlt"
              ...
              <div className="space-y-2">
                <Label htmlFor="permits">Thumbnail Image Alt Text</Label>
                <Input
                  id="thumbnailImageAlt"
                  name="thumbnailImageAlt"
                  value={formData.thumbnailImageAlt || ""}
                  onChange={handleInputChange}
                  placeholder="Describe your Thumbnail Image..."
                />
              </div>
              <div className="space-y-2">
