...
import { LucideMail, LucideMapPin, LucidePhone, LucideSend } from "lucide-react"; // Keep all icons
...
export function Form({ packages }: { packages: TPackageDetails[] }) {
  const param = useSearchParams().get("destination");
      ...
      <section className="bg-gray-100 py-16 px-4">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            {/* Right Column - Contact Info Cards (SLIGHTLY SIMPLIFIED WRAPPERS) */}
