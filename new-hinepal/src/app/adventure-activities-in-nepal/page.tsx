...
export const metadata: Metadata = {
  title: "Adventure Activities in Nepal: Top Sports & Thrill Tours",
  description:
    "Experience the ultimate thrill with the best adventure activities in Nepal. From paragliding to white water rafting and bungee, book your adventure today!",
  alternates: {
  ...
  return (
    <>
      <PageHeroSection
        icon={Pickaxe}
        title="Adventures"
        subtitle="Experience the adventure sport of lifetime amidst the Himalayas, where every thrill comes with breathtaking views."
      />
        ...
        <div className="p-2 md:p-12 container mx-auto flex flex-col gap-8">
          ...
          >
            <div className="md:max-w-[40vw]">
              ...
              <p className="text-left">
                ...
                with a long elastic rope and other safety gear. The highest
                bungee jumping in Nepal is in Kusma, which is the world’s second
                highest bungee jump. Other popular spots for bungee jump in
                Nepal are Pokhara Bungee Jump and Bhote Koshi.
              </p>
            </div>
            <div className="">
              <Image
          ...
          <div className="flex flex-col md:flex-row gap-2 md:gap-4 items-start  justify-between rounded-md p-2  md:p-8">
            ...
            <div className="md:max-w-[40vw]">
              ...
              <p className="text-left">
                Rock climbing in Nepal is an exciting adventure sport that
                offers both outdoor and indoor options for thrill-seekers of all
                skill levels. The country's diverse terrain, including Himalayan
                cliffs and lush crags, provides world-class climbing spots like
                Nagarjun, Hattiban, Bimal Nagar, and Thame. Indoor climbing gyms
                in major cities like Kathmandu and Pokhara are perfect for
                beginners and advanced climbers to practice and refine their
                skills.
              </p>
            </div>
          </div>
          ...
          >
            <div className="md:max-w-[40vw]">
              ...
              <div className="text-left">
                ...
                stunning landscapes and adrenaline-pumping adventures. One of
                the famous ziplines around the world, the Pokhara zipline in
                western Nepal offers incredible speeds with the{" "}
                <Link
                ...
                and Fewa Lake as backdrop. Dhulikhel zipline and Nagarkot
                zipline are two other popular destinations for ziplining in
                Nepal. With professional safety precautions, trained guides, and
                a variety of ride styles, it's more than just a sport; it's an
                unforgettable journey through the skies.
              </div>
            </div>
            <div className="">
              <Image
          ...
          <div className="flex flex-col md:flex-row gap-2 md:gap-4 items-start justify-between rounded-md p-2  md:p-8">
            ...
            <div className="md:max-w-[40vw]">
              ...
              <div className="text-left">
                ...
                the country's beauty. Mountain bikers can tackle rugged tracks
                in Kathmandu, Pokhara, and the Annapurna region, while leisure
                riders can enjoy peaceful lakeside paths or gentle countryside
                roads. Cycling can even enhance your day tours in Pokhara, such
                as the{" "}
                <Link
                  className="text-green-700 underline"
          ...
          <div className="flex flex-col-reverse md:flex-row gap-2 md:gap-4 items-start justify-between rounded-md p-2  md:p-8">
            <div className="md:max-w-[40vw]">
              ...
              <p className="text-left">
                Pokhara Ultralight Flight is a once-in-a-lifetime experience
                above the picturesque Pokhara Valley, surrounded by beautiful
                green hills, to witness the mesmerizing snow-crowned mountains
                to the north in a small aircraft. Enjoy the views of Annapurna,
                Machhapuchhre, Dhaulagiri, Pokhara and Lekhnath valleys, and
                Fewa Lake while touching the clouds. Choose your ultralight
                flight option:
              </p>
              <ul>
                <li>
          ...
          <div className="flex flex-col md:flex-row gap-2 md:gap-4 items-start justify-between rounded-md p-2  md:p-8">
            ...
            <div className="md:max-w-[40vw]">
              ...
              <p className="text-left">
                Rafting in Nepal is one of the thrilling and fun adventure
                sports. Peddling past the fast wave of the river by maintaining
                your balance and the raft while the cold water coming from the
                Himalayas continuously hits your face in a fast-flowing river
                between the dense green forests is a thrilling experience. Some
                of the major rafting places in Nepal are:
              </p>
          ...
          <div className="flex  md:flex-row gap-2 md:gap-4 items-start justify-between rounded-md p-2  md:p-8  flex-col-reverse">
            <div className="md:max-w-[40vw]">
              ...
              <p className="text-left">
                ...
                provides a safe and memorable flight above the Pokhara valley
                with licensed and experienced experts. Hot air balloon in
                Pokhara offers a 360-degree view of the mountains (Annapurna,
          ...
          <div className="flex flex-col md:flex-row gap-2 md:gap-4 items-start justify-between rounded-md p-2  md:p-8">
            ...
            <div className="md:max-w-[40vw]">
              ...
              <p className="text-left">
                ...
                breathtaking landscape of this country. Imagine riding through
                the adventurous, rough roads of Nepal along the lush forests,
                skimming riverbanks, and uphill tracks. ATV tour in Pokhara,
                Chitwan, and Mustang is a complete endouvring experience to
                enjoy your leisure days. Where can you do an ATV Ride?
              </p>
              <ul className="pl-4">
