                ...
                <div className='text-center mb-12 md:mb-16'>
                    <div className='max-w-4xl mx-auto'>
                        ...
                        <p className='text-gray-600 text-base md:text-lg leading-relaxed mt-4'>
                            Popular Adventures in Nepal
                        </p>
                    </div>
                </div>
                <div className='mt-8'>
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                        <AdventureCard image="/assets/bungee.webp" text="Bungee"  link="/adventure#bungee"/>
                        <AdventureCard image="/assets/paragliding.webp" text="Paragliding"  link="/adventure#paragliding"/>
                        <AdventureCard image="/assets/zipline.webp" text="Zipline"  link="/adventure#zipline"/>
                    </div>
                    <div className='text-center mt-12'>
                        <Link href='/adventure' className='inline-flex items-center justify-center px-8 py-4 bg-orange-500 text-white font-semibold rounded-full shadow-md hover:bg-orange-600 transition-colors duration-300'>
