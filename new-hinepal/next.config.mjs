...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source:
          "/wildlife-safari/chitwan-national-park/chitwan-national-park-wildlife-safari",
      ...
      {
        source:
          "/wildlife-safari/bardiya-national-park/bardiya-national-park-safari",
        destination: "/bardiya-national-park-tour",
        permanent: true,
        statusCode: 301,
      },
      ...
      {
        source:
          "/trekking/annapurna-region/nar-phu-valley-with-annapurna-circuit-trek",
        destination: "/",
        permanent: false,
        statusCode: 302,
      },
      ...
      {
        source:
          "/heli-tour/annapurna-heli-tour/experience-the-beautiful-of-kapuche-lake-by-helicopter",
        destination: "/",
        permanent: true,
        statusCode: 301,
      },
      {
        source:
          "/heli-tour/annapurna-heli-tour/helicopter-rescue-services-in-nepal",
        destination: "/",
        permanent: true,
        statusCode: 301,
      },
      ...
      {
        source:
          "/adventure-activity/rafting/expreience-the-thrill-of-kali-gandaki-river-rafting",
        destination: "/adventure",
        permanent: true,
        statusCode: 301,
      },
      {
        source:
          "/adventure-activity/hot-air-balloon/hot-air-balloon-in-pokhara",
        destination: "/adventure",
        permanent: true,
        statusCode: 301,
      },
      ...
      {
        source:
          "/best-time-to-do-annapurna-base-camp-trek-a-seasonal-guide-to-your-adventure",
