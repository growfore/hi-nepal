    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex-grow">
        ...
        <section className="relative h-96 bg-cover bg-center flex items-center justify-center ">
          <div className="min-h-[20vh] md:min-h-[40vh] mt-42 flex flex-col p-4  md:p-8 md:items-center border-b-2 border-black">
        ...
        <section className="py-16 md:py-24 lg:py-32 bg-white">
          <div className="container mx-auto px-4 md:px-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-end">
                ...
                <div className="text-gray-600 text-base md:text-lg leading-relaxed space-y-4">
                  <p>
                    ...
                    service in the tourism industry of Nepal. With over 20+
                    years of experience, our goal is to assist you in exploring
                    all the corners of Nepal and make your journey worthwhile,
                    which will last in your memories forever. Our team of
                    experienced guides and travel experts which are committed to
                    providing you safe, responsible, and comfortable tour. We
                    take pride in our professionalism, local knowledge, and
                    dedication towards sustainable tourism. From the exciting
                    trekking to the thrilling adventure sports, we lay out the
                    best according to our demands and desires.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              className="relative mt-16 rounded-xl overflow-hidden shadow-2xl aspect-video"
              style={{
                backgroundImage: "url()",
            ...
            <div className="text-center mb-12 md:mb-16">
              <div className="max-w-3xl mx-auto">
                ...
                <p className="text-gray-600 text-base md:text-lg leading-relaxed mt-4">
                  ...
                  creating lasting memories. With our years of expertise, we
